...
**Layout, rows, icons, state strings and colour are not this repo's to decide** — they are specified for all four clients in `../UI.md`, with a conformance checklist in its §11. This section covers only what is specific to this platform.
